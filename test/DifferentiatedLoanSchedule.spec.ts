...
describe('Differentiated Loan Schedule should', () => {
	test('have overall interest eq 3111.18 when params($50000/12m/11.5%/25.10.2016/25)', () => {
		...
		expect(Big(schedule.payments[schedule.payments.length - 1].paymentAmount).toFixed(2)).toEqual('4206.01')
		expect(Big(schedule.overAllInterest).toFixed(2)).toEqual('3111.18')
	})
})
